...
export const tutorials = [
    {
        ...
        difficulty: "Fácil",
        duration: "6 minutos",
        description: "Conheça os primeiros passos para criar e organizar uma planilha.",
        keywords: ["excel", "planilha", "tabela", "dados", "célula", "coluna"],
        learning: ["Criar uma planilha", "Inserir informações nas células", "Organizar dados em linhas e colunas", "Formatar os dados básicos"],
        steps: [
            {
                title: "Abra o Microsoft Excel",
                description: "Abra o Excel no computador e escolha a opção de criar uma nova pasta de trabalho em branco.",
            },
            {
                title: "Entenda as células da planilha",
                description: "Observe que a planilha é formada por linhas e colunas. Cada espaço é uma célula, identificada por uma letra e um número, como A1 ou B2.",
            },
            {
                title: "Digite os primeiros dados",
                description: "Clique em uma célula, como A1, e digite uma informação. Pressione Enter para confirmar. Use outras células para organizar os demais dados.",
            },
            {
                title: "Crie títulos para as colunas",
                description: "Na primeira linha, coloque nomes que identifiquem os dados, como Nome, Turma, Nota ou Data. Isso facilita a leitura da planilha.",
            },
            {
                title: "Ajuste a aparência dos dados",
                description: "Selecione os títulos e utilize as opções da guia Página Inicial para aplicar negrito, alterar o tamanho da fonte ou centralizar o conteúdo.",
            },
            {
                title: "Salve a planilha",
                description: "Clique em Arquivo > Salvar Como, escolha a pasta onde deseja guardar o arquivo, informe um nome e confirme o salvamento.",
            },
        ],
    },
