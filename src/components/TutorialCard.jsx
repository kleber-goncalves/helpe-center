...
export function TutorialCard({ tutorial }) {
    ...
    return (
        <Card className="flex group h-full cursor-pointer flex-col p-5 transition-all bg-card dark:bg-paper hover:-translate-y-0.5 border hover:border-coral/60 hover:shadow-lifted dark:hover:shadow-lifted-dark shadow-soft">
