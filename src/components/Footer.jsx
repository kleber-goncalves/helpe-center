...
export function Footer() {
    return (
        <footer className=" border-t border-line bg-[#f3f7f7]">
            <div className="mx-auto grid max-w-6xl gap-10 px-5 py-12 sm:grid-cols-3 lg:px-0">
                <div>
                    <p className="font-display text-base font-bold text-foreground">Central de Ajuda Digital</p>
                ...
                <div className="flex flex-col md:px-12">
                    <p className="text-sm font-bold text-coral">Central de Ajuda</p>
