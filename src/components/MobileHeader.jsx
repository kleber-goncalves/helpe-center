...
export function MobileHeader() {
    ...
    return (
        ...
        open
            ? "border-line bg-paper backdrop-blur-none shadow-none"
            : "border-line/70 bg-paper/65 backdrop-blur-sm backdrop-saturate-150 shadow-[0_8px_32px_rgb(0_0_0_/_0.08)]",
    ].join(" ")}
>
    <div
        className={[
